...
public class Pawn_Position : MonoBehaviour {
	...
	void Update () {
		...
		xDistance = Mathf.Abs ((Mathf.Abs (pawnCurrentPosition.x) - Mathf.Abs (pawnTargetPosition.x)));
		...
		zDistance = Mathf.Abs ((Mathf.Abs (pawnCurrentPosition.z) - Mathf.Abs (pawnTargetPosition.z)));
