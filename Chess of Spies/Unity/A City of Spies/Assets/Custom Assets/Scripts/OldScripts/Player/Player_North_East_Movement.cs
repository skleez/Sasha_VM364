...
public class Player_North_East_Movement : MonoBehaviour {
	...
	void OnMouseDown () {
		...
		playerPosition.rightBackSelected = true;
	...
	void Update () {
		if (playerPosition.rightBackSelected == true) {
			nextMoveMaterial.color = Color.green;
		}

		if (playerPosition.rightBackSelected == true && playerPosition.ableToMove == true) {
